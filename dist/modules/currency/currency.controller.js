...
var currency_validation_1 = __importDefault(require("@/modules/currency/currency.validation"));
...
var CurrencyController = /** @class */ (function () {
    function CurrencyController(currencyService) {
        ...
        this.fetchAll = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.currencyService.fetchAll()];
                    case 1:
                        response = _a.sent();
        ...
        this.create = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, name_1, symbol, logo, response, err_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, name_1 = _a.name, symbol = _a.symbol, logo = _a.logo;
                        return [4 /*yield*/, this.currencyService.create(name_1, symbol, logo)];
                    case 1:
                        response = _b.sent();
    ...
    CurrencyController.prototype.intialiseRoutes = function () {
        this.router.post("".concat(this.path, "/create"), http_middleware_1.default.authenticate(user_enum_1.UserRole.ADMIN), http_middleware_1.default.validate(currency_validation_1.default.create), this.create);
