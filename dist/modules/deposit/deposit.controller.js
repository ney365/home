...
var DepositController = /** @class */ (function () {
    function DepositController(depositService) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.depositService.fetchAll(true)];
                        case 1:
                            response = _a.sent();
                            return [3 /*break*/, 4];
                        case 2:
                            userId = req.user._id;
                            return [4 /*yield*/, this.depositService.fetchAll(false, userId)];
                        case 3:
                            response = _a.sent();
                            _a.label = 4;
                        case 4:
        ...
        this.fetch = function (isAdmin) {
            return function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                var response, depositId, userId, err_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 5, , 6]);
                            ...
                            return [4 /*yield*/, this.depositService.fetch(true, depositId)];
                        case 1:
                            response = _a.sent();
                            return [3 /*break*/, 4];
                        case 2:
                            userId = req.user._id;
                            return [4 /*yield*/, this.depositService.fetch(false, depositId, userId)];
                        case 3:
                            response = _a.sent();
                            _a.label = 4;
                        case 4:
        ...
        this.create = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, depositMethodId, amount, userId, response, err_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, depositMethodId = _a.depositMethodId, amount = _a.amount;
                        userId = req.user._id;
        ...
        this.updateStatus = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, depositId, status_1, response, err_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, depositId = _a.depositId, status_1 = _a.status;
                        return [4 /*yield*/, this.depositService.updateStatus(depositId, status_1)];
                    case 1:
                        response = _b.sent();
                        res.status(200).json(response);
                        return [3 /*break*/, 3];
        ...
        this.delete = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var depositId, response, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        depositId = req.params.depositId;
                        return [4 /*yield*/, this.depositService.delete(depositId)];
                    case 1:
                        response = _a.sent();
                        res.status(200).json(response);
                        return [3 /*break*/, 3];
    ...
    DepositController.prototype.intialiseRoutes = function () {
        this.router.post("".concat(this.path, "/create"), http_middleware_1.default.authenticate(user_enum_1.UserRole.USER), http_middleware_1.default.validate(deposit_validation_1.default.create), this.create);
        this.router.patch("".concat(this.path, "/update-status"), http_middleware_1.default.authenticate(user_enum_1.UserRole.ADMIN), http_middleware_1.default.validate(deposit_validation_1.default.updateStatus), this.updateStatus);
        this.router.delete("".concat(this.path, "/delete/:depositId"), http_middleware_1.default.authenticate(user_enum_1.UserRole.ADMIN), this.delete);
        ...
        this.router.get("".concat(this.path, "/:depositId"), http_middleware_1.default.authenticate(user_enum_1.UserRole.USER), this.fetch(false));
        this.router.get("".concat(this.path, "/master/:depositId"), http_middleware_1.default.authenticate(user_enum_1.UserRole.ADMIN), this.fetch(true));
