...
var itemSettings_validation_1 = __importDefault(require("@/modules/itemSettings/itemSettings.validation"));
...
var ItemSettingsController = /** @class */ (function () {
    function ItemSettingsController(itemSettingsService) {
        var _this = this;
        this.itemSettingsService = itemSettingsService;
        this.path = '/item-settings';
        ...
        this.initialiseRoutes = function () {
            ...
            //   this.create
            // )
            _this.router.put("".concat(_this.path, "/update"), http_middleware_1.default.authenticate(user_enum_1.UserRole.ADMIN), http_middleware_1.default.validate(itemSettings_validation_1.default.update), _this.update);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.itemSettingsService.create(approval, +fee)];
                    case 1:
                        response = _b.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, approval = _a.approval, fee = _a.fee;
                        return [4 /*yield*/, this.itemSettingsService.update(approval, +fee)];
                    case 1:
                        response = _b.sent();
        ...
        this.fetch = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.itemSettingsService.fetch()];
                    case 1:
                        response = _a.sent();
                        res.status(200).json(response);
                        return [3 /*break*/, 3];
