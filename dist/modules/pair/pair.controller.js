...
var PairController = /** @class */ (function () {
    function PairController(pairService) {
        ...
        this.fetchAll = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.pairService.fetchAll()];
                    case 1:
                        response = _a.sent();
        ...
        this.create = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, assetType, baseAssetId, quoteAssetId, response, err_2;
        ...
        this.update = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, pairId, assetType, baseAssetId, quoteAssetId, response, err_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, pairId = _a.pairId, assetType = _a.assetType, baseAssetId = _a.baseAssetId, quoteAssetId = _a.quoteAssetId;
                        return [4 /*yield*/, this.pairService.update(pairId, assetType, baseAssetId, quoteAssetId)];
                    case 1:
                        response = _b.sent();
                        res.status(200).json(response);
                        return [3 /*break*/, 3];
    ...
    PairController.prototype.intialiseRoutes = function () {
        this.router.post("".concat(this.path, "/create"), http_middleware_1.default.authenticate(user_enum_1.UserRole.ADMIN), http_middleware_1.default.validate(pair_validation_1.default.create), this.create);
        this.router.put("".concat(this.path, "/update"), http_middleware_1.default.authenticate(user_enum_1.UserRole.ADMIN), http_middleware_1.default.validate(pair_validation_1.default.update), this.update);
