...
var resetPassword_model_1 = __importDefault(require("@/modules/resetPassword/resetPassword.model"));
...
var resetPasswordService = /** @class */ (function () {
    function resetPasswordService() {
        var _this = this;
        this.resetPasswordModel = resetPassword_model_1.default;
        this.verify = function (key, verifyToken) { return __awaiter(_this, void 0, void 0, function () {
            var resetPassword, expires, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.resetPasswordModel.findOne({
                                key: key,
                            })];
                    case 1:
                        ...
                        return [4 /*yield*/, app_crypto_1.default.isValidHash(verifyToken, resetPassword.token)];
                    case 2:
                        if (!(_a.sent()))
                            throw new http_exception_1.default(errorCodes_enum_1.ErrorCode.BAD_REQUEST, 'Invalid or expired token');
                        resetPassword.deleteOne();
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new app_exception_1.default(err_1, 'Unable to change password, please try again');
                    case 4: return [2 /*return*/];
                }
            });
        }); };
    }
    resetPasswordService.prototype.create = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var key, token, expires, resetLink, _a, _b;
            var _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        expires = new Date().getTime() + app_constants_1.AppConstants.resetPasswordExpiresTime;
                        resetLink = "".concat(config_constants_1.SiteConstants.frontendLink, "reset-password/").concat(key, "/").concat(token);
                        return [4 /*yield*/, this.resetPasswordModel.deleteMany({ key: key })];
                    case 1:
                        _d.sent();
                        _b = (_a = this.resetPasswordModel).create;
                        _c = {
                            key: key
                        };
