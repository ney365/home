...
var TradeController = /** @class */ (function () {
    function TradeController(tradeService) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            userId = req.user._id;
                            return [4 /*yield*/, this.tradeService.fetchAll(all, environment, userId)];
                        case 1:
                            response = _a.sent();
        ...
        this.delete = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var tradeId, response, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        tradeId = req.params.tradeId;
                        return [4 /*yield*/, this.tradeService.delete(tradeId)];
                    case 1:
                        response = _a.sent();
                        res.status(200).json(response);
                        return [3 /*break*/, 3];
    ...
    TradeController.prototype.intialiseRoutes = function () {
        this.router.delete("".concat(this.path, "/delete/:tradeId"), http_middleware_1.default.authenticate(user_enum_1.UserRole.ADMIN), this.delete);
    ...
    TradeController = __decorate([
        (0, typedi_1.Service)(),
        __param(0, (0, typedi_1.Inject)(serviceToken_1.default.TRADE_SERVICE)),
