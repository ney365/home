...
var transferSettings_validation_1 = __importDefault(require("@/modules/transferSettings/transferSettings.validation"));
...
var TransferSettingsController = /** @class */ (function () {
    function TransferSettingsController(transferSettingsService) {
        var _this = this;
        this.transferSettingsService = transferSettingsService;
        this.path = '/transfer-settings';
        ...
        this.initialiseRoutes = function () {
            ...
            //   this.create
            // )
            _this.router.put("".concat(_this.path, "/update"), http_middleware_1.default.authenticate(user_enum_1.UserRole.ADMIN), http_middleware_1.default.validate(transferSettings_validation_1.default.update), _this.update);
        ...
        this.create = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, approval, fee, response, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, approval = _a.approval, fee = _a.fee;
                        return [4 /*yield*/, this.transferSettingsService.create(approval, +fee)];
                    case 1:
                        response = _b.sent();
        ...
        this.update = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, approval, fee, response, err_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, approval = _a.approval, fee = _a.fee;
                        return [4 /*yield*/, this.transferSettingsService.update(approval, +fee)];
                    case 1:
                        response = _b.sent();
        ...
        this.fetch = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.transferSettingsService.fetch()];
                    case 1:
                        response = _a.sent();
                        res.status(200).json(response);
                        return [3 /*break*/, 3];
    ...
    TransferSettingsController = __decorate([
        (0, typedi_1.Service)(),
...
exports.default = TransferSettingsController;
