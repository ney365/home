...
var transferSettings_model_1 = __importDefault(require("@/modules/transferSettings/transferSettings.model"));
...
var TransferSettingsService = /** @class */ (function () {
    function TransferSettingsService() {
        var _this = this;
        this.transferSettingsModel = transferSettings_model_1.default;
        this.update = function (approval, fee) { return __awaiter(_this, void 0, http_type_1.THttpResponse, function () {
            var transferSettings, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, transferSettings.save()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new app_exception_1.default(err_1, 'Unable to update transfer settings, please try again');
                    case 4: return [2 /*return*/];
                }
            });
        }); };
        this.get = function () { return __awaiter(_this, void 0, void 0, function () {
            var transferSettings, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.transferSettingsModel.findOne()];
                    case 1:
                        transferSettings = _a.sent();
                        return [2 /*return*/, transferSettings];
                    case 2:
                        err_2 = _a.sent();
                        throw new app_exception_1.default(err_2, 'Unable to fetch transfer settings, please try again');
    ...
    TransferSettingsService.prototype.create = function (approval, fee) {
        return __awaiter(this, void 0, http_type_1.THttpResponse, function () {
            var transferSettings, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.transferSettingsModel.create({
                                approval: approval,
                                fee: fee,
                            })];
                    case 1:
                    ...
                    case 2:
                        err_3 = _a.sent();
                        throw new app_exception_1.default(err_3, 'Unable to create transfer settings, please try again');
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    TransferSettingsService = __decorate([
        (0, typedi_1.Service)()
    ], TransferSettingsService);
    return TransferSettingsService;
}());
exports.default = TransferSettingsService;
